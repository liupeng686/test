...
![image-20241012174955278](.\第三次实验截图\image-20241012174955278.png)
...
![image-20241012180630319](.\第三次实验截图\image-20241012180630319.png)
...
1. 统计每个产品类别的总销售额。
   ...
   ![image-20241014174246865](.\第三次实验截图\image-20241014174246865.png)

   ![image-20241014174522416](.\第三次实验截图\image-20241014174522416.png)
...
2. 计算每个城市的平均订单金额。
   ...
   ![image-20241014180105394](.\第三次实验截图\image-20241014180105394.png)

   ![image-20241014180736757](.\第三次实验截图\image-20241014180736757.png)
...
3. 找出销量最高的前5个产品。
   ...
   ![image-20241014181736054](.\第三次实验截图\image-20241014181736054.png)

   ![image-20241014181828803](.\第三次实验截图\image-20241014181828803.png)
...
4. 计算男性和女性客户的平均年龄。
   ...
   ![image-20241014211638957](.\第三次实验截图\image-20241014211638957.png)
...
5. 统计每种支付方式的使用次数和总金额。
   ...
   ![image-20241014212945867](.\第三次实验截图\image-20241014212945867.png)

   ![image-20241014213022387](.\第三次实验截图\image-20241014213022387.png)
...
6. 计算每月的总销售额。
   ...
   ![image-20241014215814247](.\第三次实验截图\image-20241014215814247.png)

   ![image-20241014215858317](.\第三次实验截图\image-20241014215858317.png)
...
7. 找出平均订单金额最高的前3个客户。
   ...
   ![image-20241017163353260](.\第三次实验截图\image-20241017163353260.png)

   ![image-20241017163440298](.\第三次实验截图\image-20241017163440298.png)
...
8. 计算每个年龄段（18-30，31-50，51+）的客户数量。
   ...
   ![image-20241017164535993](.\第三次实验截图\image-20241017164535993.png)
...
9. 计算每个产品类别的平均单价
   ...
   ![image-20241017165154335](.\第三次实验截图\image-20241017165154335.png)

   ![image-20241017165227699](.\第三次实验截图\image-20241017165227699.png)
...
10. 找出订单数量最多的前5个城市。
    ...
    ![image-20241017165758804](.\第三次实验截图\image-20241017165758804.png)

    ![image-20241017165827534](.\第三次实验截图\image-20241017165827534.png)
...
11. 计算每个季度的平均订单金额。
    ...
    ![image-20241017170720543](.\第三次实验截图\image-20241017170720543.png)

    ![image-20241017170755154](.\第三次实验截图\image-20241017170755154.png)
...
12. 统计每个产品类别中的商品数量。
    ...
    ![image-20241017171517256](.\第三次实验截图\image-20241017171517256.png)

    ![image-20241017171542259](.\第三次实验截图\image-20241017171542259.png)
...
13. 计算男性和女性客户的平均订单金额。
    ...
    ![image-20241017171912353](.\第三次实验截图\image-20241017171912353.png)
...
14. 找出总销售额最高的前10个日期。
    ...
    ![image-20241017173839974](.\第三次实验截图\image-20241017173839974.png)

    ![image-20241017173859786](.\第三次实验截图\image-20241017173859786.png)
...
15. 计算每个季度销售额最高的产品类别。
    ...
    ![image-20241017174923089](.\第三次实验截图\image-20241017174923089.png)

    ![image-20241017175004813](.\第三次实验截图\image-20241017175004813.png)

    ![image-20241017175027171](.\第三次实验截图\image-20241017175027171.png)
...
![image-20241017175952350](.\第三次实验截图\image-20241017175952350.png)

错误原因：在`Elasticsearch`中，`date_histogram`聚合本身并不支持 `size` 选项，导致报错。

解决办法：可以用 `bucket_sort` 聚合来获取前10个结果。
